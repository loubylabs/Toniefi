...
related_targets: ["app/static/app.js","app/static/style.css"]
---

# TonieFi application surface

## Scope and mode

Full responsive web application shell and its primary workflows. Mode: Operate.
...
The interface must prioritize familiar controls, keyboard operation, narrow-screen use, persistent background state, truthful credential limitations, irreversible Tonie Cloud warnings, and plain-language error recovery. Visual metaphor may organize work but may never obscure state or task.

## Approved comp

Command Desk, recorded at `.impeccable/mocks/command-desk.png`. The user approved it without an additional steer.
